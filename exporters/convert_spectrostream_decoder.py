...
from mrt2_coreml.sampling import MRT2_RVQ_LEVELS, unique_token_to_raw_code
from mrt2_coreml.spectrostream_decoder_wrapper import (
...
DEFAULT_REPORT_DIR = REPO_ROOT / "build" / "validation"
DEFAULT_PACKAGE_NAME = "spectrostream_decoder_conv_nchw.mlpackage"
DEFAULT_COMPILED_NAME = "spectrostream_decoder_conv_nchw.mlmodelc"
DEFAULT_METADATA_NAME = "spectrostream_decoder_conv_nchw_export_metadata.json"
DEFAULT_REPORT_NAME = "spectrostream_decoder_conv_nchw_validation.json"
DEFAULT_SUMMARY_NAME = "spectrostream_decoder_conv_nchw_validation.md"
...
def parse_args() -> argparse.Namespace:
  ...
  parser.add_argument(
      "--nchw-parallel-layer",
      type=int,
      # Layer 5 in NCHW is the published SpectroStreamDecoder configuration
      # (layout_mode "nchw-parallel"); pass --nchw-parallel-layer -1 for the
      # plain channel-last export.
      default=5,
